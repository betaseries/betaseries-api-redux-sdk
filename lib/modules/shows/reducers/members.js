...
export default function showMembersReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case constants.FETCH_FAVORITE_SHOWS: {
      ...
      return {
        ...state,
        [userId]: _unionBy(membersNormalizer(action.payload.shows), shows, 'id')
      };
    }
    ...
    case constants.ADD_SHOW_AGENDA_REWATCH: {
    ...
    case constants.MARK_SHOW_AS_WATCHED:
    case constants.UNMARK_SHOW_AS_WATCHED:
    case constants.MARK_SHOW_AS_REWATCHED:
    case constants.UNMARK_SHOW_AS_REWATCHED: {
      const userId = BetaSeries.user.userId;
      const shows = state[userId] || [];
      ...
      return {
        ...state,
        [userId]: _unionBy(membersNormalizer(inAccountShows), shows, 'id')
      };
    }
