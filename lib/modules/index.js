...
import doClearConversationsListConversations from './conversations/actions/doClearConversationsList';
import doFetchConversationDetailConversations from './conversations/actions/doFetchConversationDetail';
import doFetchConversationsListConversations from './conversations/actions/doFetchConversationsList';
import conversationsConversations from './conversations/reducers/conversations';
import detailConversations from './conversations/reducers/detail';
import commonsConversations from './conversations/selectors/commons';
import getConversationDetailConversations from './conversations/selectors/getConversationDetail';
import getConversationsListConversations from './conversations/selectors/getConversationsList';
import getConversationsUnreadCountConversations from './conversations/selectors/getConversationsUnreadCount';
import constantsConversations from './conversations/constants';
...
export default {
  ...
  conversations: {
    actions: {
      doClearConversationsList: doClearConversationsListConversations,
      doFetchConversationDetail: doFetchConversationDetailConversations,
      doFetchConversationsList: doFetchConversationsListConversations,
    },
    reducers: {
      conversations: conversationsConversations,
      detail: detailConversations,
    },
    selectors: {
      commons: commonsConversations,
      getConversationDetail: getConversationDetailConversations,
      getConversationsList: getConversationsListConversations,
      getConversationsUnreadCount: getConversationsUnreadCountConversations,
    },
    constants: constantsConversations,
  },
  members: {
    actions: {
