...
import doFetchSubscribedCollectionListCollections from './collections/actions/doFetchSubscribedCollectionList';
...
import doSubscribeCollectionCollections from './collections/actions/doSubscribeCollection';
import doToggleNotificationsCollectionCollections from './collections/actions/doToggleNotificationsCollection';
import doUnsubscribeCollectionCollections from './collections/actions/doUnsubscribeCollection';
...
import subscribedCollections from './collections/reducers/subscribed';
...
import getCollectionSubscribedListCollections from './collections/selectors/getCollectionSubscribedList';
...
import doFetchHomeQuizHome from './home/actions/doFetchHomeQuiz';
...
import quizHome from './home/reducers/quiz';
...
import getHomeQuizHome from './home/selectors/getHomeQuiz';
...
import doAddMovieAgendaRewatchMovies from './movies/actions/doAddMovieAgendaRewatch';
...
import doMarkMovieAsRewatchedMovies from './movies/actions/doMarkMovieAsRewatched';
...
import doUnmarkMovieAsRewatchedMovies from './movies/actions/doUnmarkMovieAsRewatched';
import doUpdateMovieRewatchDatesMovies from './movies/actions/doUpdateMovieRewatchDates';
import doUpdateMovieStateMovies from './movies/actions/doUpdateMovieState';
import doUpdateMovieWatchDateMovies from './movies/actions/doUpdateMovieWatchDate';
...
import doAnswerQuizQuiz from './quiz/actions/doAnswerQuiz';
import doFetchGlobalRankingQuiz from './quiz/actions/doFetchGlobalRanking';
import doFetchMonthlyRankingQuiz from './quiz/actions/doFetchMonthlyRanking';
import doFetchQuizQuiz from './quiz/actions/doFetchQuiz';
import doFetchQuizHistoryQuiz from './quiz/actions/doFetchQuizHistory';
import doFetchQuizListQuiz from './quiz/actions/doFetchQuizList';
import doFetchQuizRankingQuiz from './quiz/actions/doFetchQuizRanking';
import globalRankingQuiz from './quiz/reducers/globalRanking';
import historyQuiz from './quiz/reducers/history';
import membersQuiz from './quiz/reducers/members';
import monthRankingQuiz from './quiz/reducers/monthRanking';
import quizQuiz from './quiz/reducers/quiz';
import rankingQuiz from './quiz/reducers/ranking';
import commonsQuiz from './quiz/selectors/commons';
import getGlobalRankingQuiz from './quiz/selectors/getGlobalRanking';
import getMonthlyRankingQuiz from './quiz/selectors/getMonthlyRanking';
import getQuizQuiz from './quiz/selectors/getQuiz';
import getQuizHistoryQuiz from './quiz/selectors/getQuizHistory';
import getQuizListQuiz from './quiz/selectors/getQuizList';
import getQuizRankingQuiz from './quiz/selectors/getQuizRanking';
import constantsQuiz from './quiz/constants';
...
import doAddShowAgendaRewatchShows from './shows/actions/doAddShowAgendaRewatch';
...
import doUpdateEpisodeRewatchDatesShows from './shows/actions/doUpdateEpisodeRewatchDates';
import doUpdateEpisodeWatchDateShows from './shows/actions/doUpdateEpisodeWatchDate';
...
import doUploadTvTimeZipSync from './sync/actions/doUploadTvTimeZip';
...
export default {
  ...
  collections: {
    actions: {
      ...
      doFetchSubscribedCollectionList: doFetchSubscribedCollectionListCollections,
      doPostCollection: doPostCollectionCollections,
      doRemoveCollection: doRemoveCollectionCollections,
      doSubscribeCollection: doSubscribeCollectionCollections,
      doToggleNotificationsCollection: doToggleNotificationsCollectionCollections,
      doUnsubscribeCollection: doUnsubscribeCollectionCollections,
    },
    reducers: {
      collections: collectionsCollections,
      members: membersCollections,
      subscribed: subscribedCollections,
    },
    selectors: {
      commons: commonsCollections,
      getCollection: getCollectionCollections,
      getCollectionList: getCollectionListCollections,
      getCollectionSubscribedList: getCollectionSubscribedListCollections,
    },
  ...
  home: {
    actions: {
      ...
      doFetchHomeQuiz: doFetchHomeQuizHome,
  ...
  movies: {
    actions: {
      doAddMovieAgendaRewatch: doAddMovieAgendaRewatchMovies,
      ...
      doMarkMovieAsRewatched: doMarkMovieAsRewatchedMovies,
      ...
      doUnmarkMovieAsRewatched: doUnmarkMovieAsRewatchedMovies,
      doUpdateMovieRewatchDates: doUpdateMovieRewatchDatesMovies,
      doUpdateMovieState: doUpdateMovieStateMovies,
      doUpdateMovieWatchDate: doUpdateMovieWatchDateMovies,
    },
    reducers: {
  ...
  quiz: {
    actions: {
      doAnswerQuiz: doAnswerQuizQuiz,
      doFetchGlobalRanking: doFetchGlobalRankingQuiz,
      doFetchMonthlyRanking: doFetchMonthlyRankingQuiz,
      doFetchQuiz: doFetchQuizQuiz,
      doFetchQuizHistory: doFetchQuizHistoryQuiz,
      doFetchQuizList: doFetchQuizListQuiz,
      doFetchQuizRanking: doFetchQuizRankingQuiz,
    },
    reducers: {
      globalRanking: globalRankingQuiz,
      history: historyQuiz,
      members: membersQuiz,
      monthRanking: monthRankingQuiz,
      quiz: quizQuiz,
      ranking: rankingQuiz,
    },
    selectors: {
      commons: commonsQuiz,
      getGlobalRanking: getGlobalRankingQuiz,
      getMonthlyRanking: getMonthlyRankingQuiz,
      getQuiz: getQuizQuiz,
      getQuizHistory: getQuizHistoryQuiz,
      getQuizList: getQuizListQuiz,
      getQuizRanking: getQuizRankingQuiz,
    },
    constants: constantsQuiz,
  },
  reports: {
    actions: {
  ...
  shows: {
    actions: {
      ...
      doAddShowAgendaRewatch: doAddShowAgendaRewatchShows,
      ...
      doUpdateEpisodeRewatchDates: doUpdateEpisodeRewatchDatesShows,
      doUpdateEpisodeWatchDate: doUpdateEpisodeWatchDateShows,
    },
    reducers: {
  ...
  sync: {
    actions: {
      ...
      doUploadTvTimeZip: doUploadTvTimeZipSync,
    },
