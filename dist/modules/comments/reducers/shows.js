...
exports.default = showCommentsReducer;
 ...
 * @returns {Object}
 */
function showCommentsReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  var action = arguments[1];

  switch (action.type) {
    case _constants2.default.FETCH_SHOW_COMMENTS:
      return _extends({}, state, _defineProperty({}, action.payload.showId, (0, _arrayToID2.default)(action.payload.comments)));
