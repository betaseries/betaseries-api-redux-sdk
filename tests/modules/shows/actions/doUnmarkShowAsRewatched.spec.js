...
const actionFile = '../lib/modules/shows/actions/doUnmarkShowAsRewatched';
const showsFixture = require('../../../fixtures/shows.json');

describe('Unmark show as rewatched', () => {
  /**
   * getInstance method
   */
  ...
  describe('call api with shows ID list', () => {
    ...
    it('validate action', () => {
      expect(action.type).to.equal('UNMARK_SHOW_AS_REWATCHED');
