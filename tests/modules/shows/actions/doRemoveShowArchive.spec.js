...
const actionFile = '../lib/modules/shows/actions/doRemoveShowArchive';
const showsFixture = require('../../../fixtures/shows.json');

describe('Remove a show from archives', () => {
  /**
   * getInstance method
   */
  ...
  describe('call api with a show removed from archives', () => {
    let action;
    ...
    it('validate action', () => {
      expect(action.type).to.equal('REMOVE_SHOW_ARCHIVE');
